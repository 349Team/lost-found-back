...
-- CreateIndex
CREATE INDEX "userA_id" ON "Message"("userA_id");

-- CreateIndex
CREATE INDEX "userB_id" ON "Message"("userB_id");

-- CreateIndex
CREATE INDEX "object_id" ON "Message"("object_id");
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_user" FOREIGN KEY ("userA_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_user" FOREIGN KEY ("userB_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_user" FOREIGN KEY ("objectId") REFERENCES "Object"("id") ON DELETE SET NULL ON UPDATE CASCADE;
